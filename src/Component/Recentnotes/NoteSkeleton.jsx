...
const NoteSkeleton = memo(({ isGridView }) => {
    return (
        <div className={`relative flex flex-col gap-4 p-5 bg-[#121212] border border-[#262626] rounded-xl overflow-hidden animate-pulse ${isGridView ? 'h-48' : 'h-36'}`}>
            {/* Shimmer Effect */}
            ...
            <div className="mt-2 space-y-3">
                ...
                <div className="space-y-2">
                    ...
                    {isGridView && <div className="h-4 w-4/6 bg-[#1a1a1a] rounded" />}
                </div>
            </div>
