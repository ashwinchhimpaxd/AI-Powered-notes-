...
function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      {/* Visual toggle pill */}
      <div className={`w-10 h-6 rounded-full p-1 transition-colors duration-300 ${theme === "dark" ? "bg-primary" : "bg-muted"
        }`}>
        <div className={`w-4 h-4 rounded-full bg-white shadow-md transform transition-transform duration-300 ${theme === "dark" ? "translate-x-4" : "translate-x-0"
          }`} />
      </div>
    </button>
  );
